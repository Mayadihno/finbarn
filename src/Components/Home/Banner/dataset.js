import image1 from "../../../Assets/Carocel-image/charcoal.jpg";
import image2 from "../../../Assets/Carocel-image/cocoa.jpg";
import image3 from "../../../Assets/cashew/Cashew kernel.jpeg";
import image4 from "../../../Assets/Carocel-image/seasame.jpg";
import image5 from "../../../Assets/Carocel-image/Shea-butter.jpg";
...
const data = [
  {
    ...
    textBig:
      "Welcome to Finbarn Wepo Agro Allied Commodities and Logistics solutions",
    textSmall:
  ...
  },
  {
    ...
    textSmall:
      "As a fast-growing company, we want to ensure trust in our customers. Hence, we are registered with the Nigerian Export Promotion Council.",
  },
  {
    id: 2,
    image: image2,
    textBig:
      "Ensuring standards of quality and quantity with Our Agricultural Commodities",
    textSmall:
      "Our materials for exports in Nigeria are FoodStuffs and agricultural commodities of the finest quality.",
  },
  {
    id: 3,
    image: image3,
    textBig: "Trading Globally for nearly a decade",
    textSmall:
      "Since our inception in 2018, Finbarn has been an up-and-coming commodities and trading company based out of Nigeria.",
  },
  {
    id: 4,
    image: image4,
    textBig: "Quality Agro Allied Products",
    textSmall:
      "Quality means doing it right when no one is looking. Our Product is always the Best among the rest",
  },
  {
    id: 5,
    image: image5,
    textBig: "Grade Perfection",
    textSmall:
      "Perfection is achieved, not when there is nothing more to add, but when there is nothing left to take away.Our Product are always Top Notch",
  },
  {
    id: 6,
    image: image6,
    textBig: "We Connect Countries",
    textSmall: " We Trade Our Agro Commodities around the world....",
  },
];
export default data;
